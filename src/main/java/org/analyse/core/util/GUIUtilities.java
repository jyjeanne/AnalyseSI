...
public final class GUIUtilities
{
    ...
    {
        JOptionPane.showMessageDialog(Main.analyseFrame, text,
	...
	public static int  question_YES_NO_CANCEL (String question) {
		return JOptionPane.showConfirmDialog(Main.analyseFrame, question, Utilities.getLangueMessage ("analysesi"), JOptionPane.YES_NO_CANCEL_OPTION)  ;
	}
	
	public static int  question_YES_NO (String question) {
		return JOptionPane.showConfirmDialog(Main.analyseFrame, question, Utilities.getLangueMessage ("analysesi"), JOptionPane.YES_NO_OPTION)  ;
	}
	 ...
	 * Ces polices sont stockées dans le dossier resources/fonts.
	...
	public static Font openFont(String name)
	{
		...
		Font font = null;
		InputStream is = GUIUtilities.class.getClassLoader().getResourceAsStream("fonts/" + name);
